...
ActiveRecord::Schema[7.1].define(version: 2024_03_27_170328) do
  ...
  create_table "spree_import_columns", force: :cascade do |t|
    t.integer "import_id"
  ...
  create_table "spree_imports", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["active"], name: "index_spree_imports_on_active"
    t.index ["update_desc"], name: "index_spree_imports_on_update_desc"
    t.index ["update_img"], name: "index_spree_imports_on_update_img"
    t.index ["update_price"], name: "index_spree_imports_on_update_price"
    t.index ["update_quantity"], name: "index_spree_imports_on_update_quantity"
    t.index ["update_title"], name: "index_spree_imports_on_update_title"
  end
